...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "]", function() awful.util.spawn("rofi -show ssh") end,
              {description = "show the ssh", group = "launcher"})
)
...
beautiful.border_focus = "#f00e41"
beautiful.border_normal = "#1c0006"
...
beautiful.wallpaper="~/.wallpaper/warhammer-40-000-sisters-of-battle-warrior-girl-soldier-gun.jpg"
